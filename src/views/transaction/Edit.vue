        ...
        <div class="row justify-content-center">
            <div class="col-8">
                <router-link
                    ...
                    class="btn btn-secondary btn-sm rounded shadow mb-3"
                >Back</router-link>
                ...
                <div class="card-body">
                    <form @submit.prevent="update()">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" v-model="transaction.time" placeholder="yyy-mm-dd hh:mm:ss">
...
export default {
    setup() {
        ...
        onMounted(() => {
            axios.get(`http://localhost:8000/api/v1/transactions/${route.params.id}`)
            .then((result) => {
        ...
        function update() {
            axios.put(
                `http://localhost:8000/api/v1/transactions/${route.params.id}`,
                transaction
            )
            .then(() => {
                router.push({
